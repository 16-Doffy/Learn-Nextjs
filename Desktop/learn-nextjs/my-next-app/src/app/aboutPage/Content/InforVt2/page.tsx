...
import vt2 from '../../img/vt2.jpg';
// import vt23 from '../../img/vt23.jpg';
// import vt24 from '../../img/vt24.jpg';
// import vt25 from '../../img/vt25.jpg';
import Image from 'next/image';
const imageList = [
  { src: vt2, alt: 'DanyanCat 1' },
  { src: vt2, alt: 'DanyanCat 2' },
  { src: vt2, alt: 'DanyanCat 3' },
  { src: vt2, alt: 'DanyanCat 4' },
  { src: vt2, alt: 'DanyanCat 4' },
  { src: vt2, alt: 'DanyanCat 1' },
  { src: vt2, alt: 'DanyanCat 2' },
  { src: vt2, alt: 'DanyanCat 3' },
];
export default function Inforvt2() {
  return (
